#!/usr/bin/python3
'''
fabric code that shares an archive to web servers
...
env.hosts = ['34.202.159.246', '54.208.173.202']


def do_deploy(archive_path):
    """Shares an archive to a web server.
    Args:
...
def do_deploy(archive_path):
    """Shares the static files into the host servers.
    Args:
