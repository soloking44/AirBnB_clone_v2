...
class test_basemodel(unittest.TestCase):
    ...
    """
    This is class that check pep8 on base_model file"""
    ...
    def test_str_method(self):
        """Checking will return STR method"""
        instance6 = BaseModel()
...
class TestCodeFormat(unittest.TestCase):
    """
    It is a class that check pep8 on base_model file"""
    def test_pycodestyle(self):
        """
        Check pep8 format
        """
...
class TestBaseModel(unittest.TestCase):
    """It will check the base model class x"""
    ...
    @classmethod
    def teardown(cls):
        """If the test is concluded this will dismantle it"""
        del cls.base
    ...
    def test_method_BaseModel(self):
        """Verifying if Basemodel possesses methods"""
        self.assertTrue(hasattr(BaseModel, "__init__"))
        self.assertTrue(hasattr(BaseModel, "save"))
        self.assertTrue(hasattr(BaseModel, "to_dict"))

    def test_init_BaseModel(self):
        """Check whether the base is of type BaseModel"""
        self.assertTrue(isinstance(self.base, BaseModel))

    def test_save_BaesModel(self):
        """Check the functionality of the save"""
        self.base.save()
        self.assertNotEqual(self.base.created_at, self.base.updated_at)

    def test_to_dict_BaseModel(self):
        """Check the functionality of the dictionary"""
