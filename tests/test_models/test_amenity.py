...
class test_inherit_basemodel(unittest.TestCase):
    """Check that user inherit from BaseModel"""
...
class TestAmenity(unittest.TestCase):
    """It check the Amenity class"""

    def test_is_subclass(self):
        """Check if Amenity are subclass of BaseModel"""
        amenity = Amenity()
    ...
    def test_name_attr(self):
        """Check if the Amenity class bears attribute "name", so its value has empty string"""
        amenity = Amenity()
    ...
    def test_to_dict_creates_dict(self):
        """Check that the to_dict method generates a dictionary with right attributes"""
        am = Amenity()
        print(am.__dict__)
        new_d = am.to_dict()
    ...
    def test_to_dict_values(self):
        """Check if the data in dict generate within to_dict is accurate"""
    ...
    def test_str(self):
        """Check if the 'str' method gives the expected output"""
        amenity = Amenity()
