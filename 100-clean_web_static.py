#!/usr/bin/python3
"""
do_pack(): this gets a .tgz archive from the
properties of web_static
do_deploy(): this gets archive web server
deploy (): this designs archive to web server
do_clean(): this removes out of date archives
"""
...
def do_pack():
    """this reduces the files in archive"""
...
def deploy():
    """this designs archive to web server"""
    filepath = do_pack()
    if filepath is None:
        return False
...
def do_clean(number=0):
    """this removes out of date archives"""
